...
func NewChannelPool(poolConfig *PoolOption) (Pool, error) {
	...
	_factory := func() (interface{}, error) {
		return net.Dial(poolConfig.Network, poolConfig.Address)
	}
	_close := func(v interface{}) error { return v.(net.Conn).Close() }
